...
<h1>Consult with a Doctor</h1>
    <form method="post" action="login.php">
        <div class="mb-3">
          ...
          <input class="form-control" type="text" value="Stomach and Digestion : Rs 499" aria-label="readonly input example" readonly>
          </div>
        </div>
        <div class="mb-3">
          <label for="passwd" class="form-label">Patient name :</label>
          <div class="col-sm-10">
